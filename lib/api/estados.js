...
api.getStateRegion = ({ state = requiredParam('state') }) => (0, _find2.default)(regions, region => (0, _find2.default)(region.states, regionState => {
...
api.getStateCities = ({ state = requiredParam('state') }) => {
  ...
  const stateFound = (0, _find2.default)(states, findState);
  if (stateFound) {
