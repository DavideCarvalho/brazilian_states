...
api.getStateCities = ({ state = requiredParam('state') }) => _.find(states, element => element.state === state || element.abbreviation === state);

api.getCityState = ({ city = requiredParam('city'), returnEntireJson = false }) => {
